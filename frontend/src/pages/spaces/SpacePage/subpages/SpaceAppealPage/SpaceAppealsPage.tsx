...
import { TaskStatus, AppealCard } from '@entities/space';

import { getBemClasses, typedMemo } from '@shared/lib';
import { ClassNameProps, TestProps } from '@shared/types';
import { FlexContainer, Input, NavTab } from '@shared/ui';

import styles from './SpaceAppealsPage.module.css';

export type Props = ClassNameProps & TestProps & Readonly<{}>;

export const SpaceAppealsPage: FC<Props> = typedMemo(function SpaceAppealsPage({
    className,
    'data-testid': dataTestId = 'SpaceAppealsPage',
}) {
